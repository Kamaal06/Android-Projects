    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Class2.this,showAct.class));
                finish();
            }
        });
        ...
        NoticeImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Class2.this, noticeAct.class));
                finish();
        ...
        GalleryImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Class2.this,GalleryAct.class));
                finish();
            }
        });


        getSupportActionBar().setTitle("Welcome To CLass 2");
