    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Class3.this,showAct.class));
                finish();
            }
        });
        ...
        NoticeImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Class3.this, noticeAct.class));
                finish();
        ...
        GalleryImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Class3.this,GalleryAct.class));
                finish();
            }
        });


        getSupportActionBar().setTitle("Welcome To CLass 3");
