       ...
       // empl.setText("Username is "+name+ "Player Id is "+note);
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name.getText().toString().trim())){
                    Toast.makeText(Main2Activity.this," Name is invalid", Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(upivirtualid.getText().toString().trim())){
                    Toast.makeText(Main2Activity.this," UPI ID is invalid", Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(note.getText().toString().trim())){
                    Toast.makeText(Main2Activity.this," Note is invalid", Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(amount.getText().toString().trim())){
                    Toast.makeText(Main2Activity.this," Amount is invalid", Toast.LENGTH_SHORT).show();
                }else{
